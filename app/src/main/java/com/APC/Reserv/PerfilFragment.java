...
public class PerfilFragment extends Fragment {
    ...
    private TextView nombreperfil, correoperfil, telefonoperfil, ciudadperfil;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.APC.Reserv.R.layout.fragment_perfil, container, false);
        //
        ctx = getActivity();
        assert ctx != null;
        ...
        fotoperfil = view.findViewById(com.APC.Reserv.R.id.fotoperfil);

        nombreperfil = view.findViewById(com.APC.Reserv.R.id.nombreperfil);
        correoperfil = view.findViewById(com.APC.Reserv.R.id.correoperfil);
        telefonoperfil = view.findViewById(com.APC.Reserv.R.id.telefonoperfil);
        ciudadperfil = view.findViewById(com.APC.Reserv.R.id.ciudadperfil);

        settexts();

        buttoneditar = view.findViewById(com.APC.Reserv.R.id.buttoneditar);
                    ...
                    public void onResponse(JSONArray response) {
                        for(int i=0; i < response.length(); i++) {
                            try {
                                ...
                                if (res.has("nombre")){ ciudadperfil.setText(res.getString("nombre")); }
                                else { ciudadperfil.setText(usrciudad); }
